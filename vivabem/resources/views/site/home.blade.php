                ...
                <div class="row global-carousel service-slider-1 style2" data-slide-show="4" data-ml-slide-show="3" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="1" data-xs-slide-show="1" data-dots="false">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-card_content">
                                <h4 class="service-card_title h5"><a href="service-details.html">Treino Funcional</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-card_content">
                                <h4 class="service-card_title h5"><a href="service-details.html">Supino Curvo</a></h4>
                                <p class="service-card_text">Exercício de levantamento de peso para fortalecimento do peitoral. Usando barra e bancada.</p>
                                <a href="service-details.html" class="link-btn" tabindex="0">Leia mais..<i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-card_content">
                                <h4 class="service-card_title h5"><a href="service-details.html">Agachamento Livre</a></h4>
                                <p class="service-card_text">Exercício de levantamento de peso para fortalecimento das pernas. Realizando sem auxílio de máquinas</p>
                                <a href="service-details.html" class="link-btn" tabindex="0">Leia mais..<i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-card_content">
                                <h4 class="service-card_title h5"><a href="service-details.html">Puxada de Costas</a></h4>
                                <p class="service-card_text">Aula de alongamento e fortalecimento</p>
                                <a href="service-details.html" class="link-btn" tabindex="0">Leia mais..<i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
